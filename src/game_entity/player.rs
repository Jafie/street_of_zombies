...
impl Player {
    ...
    pub fn new(speed_to_set: f32, direction_to_set: (f32, f32), initial_pos: (f32, f32)) -> Self {
        Player {
                player_data : PlayerInternal {
                        ...
                        sprite_data: MoveableSprite::new(speed_to_set, direction_to_set, initial_pos, DEFAULT_PLAYER_HITBOX_SIZE),
        }
    }
    ...
    pub fn fire(&mut self,
        ...
        time: &Res<Time>) {
            self.player_data.current_weapon.fire_global(commands, materials, &time, self.sprite_data.get_direction(), self.sprite_data.get_position(), false);
    }
